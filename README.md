...
I used monthly India CPI data to explore how inflation changed over time and what was happening underneath the headline numbers.

This project looks at inflation from five different angles — CPI category contributions, long-term inflation trends, food prices, the impact of COVID-19, and imported crude oil movements.
...
Excel | Data Cleaning | Data Analysis | Pivot Analysis | CORREL | AVERAGEIFS | SUMIFS | INDEX-MATCH | Charts | Dashboard

The goal of the project was simple: turn a large CPI dataset into a clear economic story that can actually be understood from the numbers.
